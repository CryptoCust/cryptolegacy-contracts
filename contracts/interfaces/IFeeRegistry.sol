...
interface IFeeRegistry {
    ...
    event AccumulateFee(address indexed referrer, bytes8 indexed code, address indexed recipient, uint256 value, bytes transferResponse);
    event CreateCode(address indexed codeOperator, address indexed referrer, bytes8 indexed code, address recipient, uint256 fromChain, uint32 discountPct, uint32 sharePct);
    event UpdateCode(address indexed codeOperator, address indexed referrer, bytes8 indexed code, address recipient, uint256 fromChain, uint32 discountPct, uint32 sharePct);
    ...
    function createCustomCode(address _referrer, address _recipient, bytes8 _shortCode, uint256[] memory _chainIds, uint256[] memory _crossChainFees) external payable returns(bytes8 code, uint256 totalFee, uint256 returnValue);
    function createCode(address _referrer, address _recipient, uint256[] memory _chainIds, uint256[] memory _crossChainFees) external payable returns(bytes8 code, uint256 totalFee, uint256 returnValue);
    function updateCrossChainsRef(address _referrer, uint256[] memory _chainIds, uint256[] memory _crossChainFees) external payable returns(uint256 totalFee, uint256 returnValue);
    ...
    error WithdrawAccumulatedFeeFailed(bytes reason);
...
interface ILockChainGate {
    ...
    event SetLockPeriodConfig(uint256 lockPeriod, uint256 transferTimeout);
    ...
    function lockLifetimeNft(uint256 _tokenId, address _owner, uint256[] memory _lockToChainIds, uint256[] memory _crossChainFees) external payable returns(uint256 returnValue);
